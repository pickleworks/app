...
/*		when trying to fix format to be the following I get "invalid date" error on datepicker.php ::: has to be this format as that's how it is in the database... 
